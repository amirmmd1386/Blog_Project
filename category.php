...
<head>
    ...
    <title>بلاگ | دسته بندی شده</title>
</head>
...
<body class="bg-blog">
    ...
    <div class="container-fluid p-0 m-0 bc-drop-filter" dir="rtl">
        ...
        <article class="col-11 col-lg-8  m-auto mt-5">
            <div class="container-fluid overflow-y-scroll d-flex flex-column gap-4 " style="height: 600px;">
                <?php
                $link = mysqli_connect("localhost", "root", "", "blog_dbl");
                $quSelect = "select * from content_tbl where contentCategory = '$_GET[id]'";
